...
public class ShooterCommandFar extends CommandBase {
    ...
    private double distanceToGoal = 201.0; // TODO set back to 0 when distance is working

    // Constructor.
    public ShooterCommandFar(ShooterSpeedController shooterSpeedController, HopperController hopperController,
